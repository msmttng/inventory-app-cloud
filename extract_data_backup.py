...
async def run_extraction():
    ...
    # GitHub Secrets から Googleログイン状態 (Base64) を復元
    state_path = None
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            try:
                ...
                print(f"[{datetime.now()}] ⚠️ Looker Studio Error: {e}")
            ...
            try:
                ...
                if medorder_token:
                    ...
                    for i in range(0, len(id_list), 50):
                        ...
                        await asyncio.sleep(0.5) # レートリミット配慮
                    ...
                    print(f"[{datetime.now()}] ⚠️ Token capture failed: {status}")
            ...
            if not epi_email or not epi_password:
                ...
                try:
                    ...
                    print(f"[{datetime.now()}] ⚠️ Order-EPI Error: {e}")
